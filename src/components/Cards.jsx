...
export default function Cards(props) {
  return (
    <div className="card bg-sky-950 shadow-md shadow-current hover:text-white p-7 rounded-md mb-5 mt-10 h-auto py-5 hover:bg-black transition-colors duration-100 group">
